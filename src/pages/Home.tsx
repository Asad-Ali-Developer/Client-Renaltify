...
import {
  ...
  AiOutlineFileText,
  AiOutlineLoading,
} from "react-icons/ai"; // Replaced icons
          ...
          >
            ...
            >
              ...
              <Text
                ...
                mb={6}
              >
                Streamline your tenant data, automate rent collection, and gain
                valuable insights with our cutting-edge platform.
              </Text>
              ...
              {[
                {
                  ...
                  description:
                    "Manage all your properties effortlessly from one dashboard",
                },
                {
                  icon: AiOutlineTeam,
                  title: "Tenant Insights",
                  description:
                    "Gain valuable insights into your tenants' behavior and preferences",
                },
                {
                  icon: AiOutlineFileText,
                  title: "Automated Documentation",
                  description:
                    "Generate and manage leases and other documents automatically",
                },
                {
                  icon: AiOutlineLoading,
                  title: "Real-time Analytics",
                  description:
                    "Access real-time data and analytics to make informed decisions",
                },
              ].map((feature, index) => (
                <motion.div
                  key={index}
                  style={{
                    backgroundColor: colorMode === "dark" ? "#2A2A2A" : "white",
                    padding: "1.5rem",
                    borderRadius: "8px",
                  }}
